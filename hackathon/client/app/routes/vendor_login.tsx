...
// import { getVendor } from "~/redux/actions"; // Assumed vendor action
    ...
    try {
      ...
      setError(
        error?.response?.data?.message ||
          "Failed to login. Check credentials or approval status."
      );
      toast.error(
        error?.response?.data?.message ||
          "Failed to login. Check credentials or approval status."
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-100 to-purple-200 p-4 sm:p-6 flex items-center justify-center relative">
      ...
      <div className="w-full max-w-5xl bg-white shadow-2xl rounded-2xl overflow-hidden flex flex-col md:flex-row transform transition-all duration-300 hover:shadow-3xl">
        <div className="w-full md:w-1/2 p-8 sm:p-10 md:p-12 flex flex-col justify-center bg-white">
          ...
          >
            Sign in to your E-Shop Vendor Dashboard.
          </motion.p>
          <AnimatePresence>
            {error && (
              <motion.div
            ...
            >
              ...
              <div className="relative">
                <input
                  ...
                  autoComplete="email"
                  required
                  className={`w-full px-4 py-3 border text-black border-gray-200 rounded-lg shadow-sm focus:ring-2 focus:ring-purple-400 focus:border-purple-500 transition-all duration-200 bg-gray-50 hover:bg-white pl-10 ${
            ...
            >
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className={`w-full px-4 py-3 border text-black border-gray-200 rounded-lg shadow-sm focus:ring-2 focus:ring-purple-400 focus:border-purple-500 transition-all duration-200 bg-gray-50 hover:bg-white pl-10 pr-10 ${
                    loading ? "opacity-50 cursor-not-allowed" : ""
                  }`}
                  placeholder="••••••••"
                  value={password}
            ...
            >
              <div className="flex items-center">
                <input
                  ...
                  name="remember-me"
                  type="checkbox"
                  className="h-4 w-4 text-purple-600 focus:ring-purple-400 border-gray-300 rounded transition duration-200"
                  disabled={loading}
                />
        ...
        <div className="hidden md:block md:w-1/2 p-10 bg-gradient-to-br from-purple-600 to-indigo-700 flex flex-col justify-center items-center text-white text-center relative overflow-hidden">
          ...
          <motion.p
            ...
            transition={{ duration: 0.5, delay: 0.1 }}
          >
            Access your dashboard, manage products, fulfill orders, and view sales analytics.
          </motion.p>
        </div>
      </div>
    </div>
