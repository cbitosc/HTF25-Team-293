...
// import { getAdmin } from "~/redux/actions"; // Assumed admin action
...
import Security from "@mui/icons-material/Security"; // Icon for admin page
...
export default function AdminLogin() { 
    ...
    try {
      ...
      setError(
        error?.response?.data?.message ||
          "Failed to login. Invalid credentials or not authorized."
      );
      toast.error(
        error?.response?.data?.message ||
          "Failed to login. Invalid credentials or not authorized."
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-200 to-red-200 p-4 sm:p-6 flex items-center justify-center relative">
      <AnimatePresence>
        {loading && (
          <motion.div
      ...
      <div className="w-full max-w-5xl bg-white shadow-2xl rounded-2xl overflow-hidden flex flex-col md:flex-row transform transition-all duration-300 hover:shadow-3xl">
        <div className="w-full md:w-1/2 p-8 sm:p-10 md:p-12 flex flex-col justify-center bg-white">
          ...
          >
            E-Shop Management & Administration
          </motion.p>
          <AnimatePresence>
            {error && (
              <motion.div
          ...
          >
            ...
            >
              ...
              <div className="relative">
                <input
                  ...
                  autoComplete="email"
                  required
                  className={`w-full px-4 py-3 border text-black border-gray-200 rounded-lg shadow-sm focus:ring-2 focus:ring-red-400 focus:border-red-500 transition-all duration-200 bg-gray-50 hover:bg-white pl-10 ${
            ...
            >
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className={`w-full px-4 py-3 border text-black border-gray-200 rounded-lg shadow-sm focus:ring-2 focus:ring-red-400 focus:border-red-500 transition-all duration-200 bg-gray-50 hover:bg-white pl-10 pr-10 ${
                    loading ? "opacity-50 cursor-not-allowed" : ""
                  }`}
                  placeholder="••••••••"
                  value={password}
            ...
            <motion.button
              onClick={handleLogin}
              disabled={loading}
              className={`w-full py-3 px-4 bg-red-600 text-white font-semibold rounded-lg shadow-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-400 transition-all duration-200 flex items-center justify-center ${
                loading ? "opacity-50 cursor-not-allowed" : ""
              }`}
              variants={{
        ...
        <div className="hidden md:block md:w-1/2 p-10 bg-gradient-to-br from-red-600 to-gray-800 flex flex-col justify-center items-center text-white text-center relative overflow-hidden">
